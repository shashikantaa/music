...
<html lang="en">
  ...
  <div class="sidebar">
      ...
      <div class="navigation" id="upper">
        <ul>
          ...
          <a href="disp_play.php" style="color:#b3b3b3;text-decoration:none;font-size:12px; font-weight:bold;">
    ...
    <div class="main-container">
      ...
      <h3 style="text-align:left;color:white">MY SONGS</h3>
      <!--SONGS DISPLAY-->
      <?php 
	@$i=$_SESSION['id'];
	if(!empty($_SESSION['id']))
	{
    		...
    		@$ins="SELECT * FROM tb_play where uid='$i'";
  ...
  <table align="center" width="100%" style="background-color:black; border-color:white; border-top:none; border-left:none; border-right:none; border-top-color:black; border-right-color:black; border-left-color:black;">
		...
		<td>
		<a href="dele_play.php?a=<?php echo $value['artist_id'];?>&l=<?php echo $value['loc'];?>&s=<?php echo $value['song_name'];?>" class="play_1">Remove From Playlist</a>
			</td>
        </tr>
...
<?php } 
	...
	echo "<h6 align=center style='color:white'>","LOGIN TO ADD SONGS IN PLAYLIST","</h1>";
	}
?>
