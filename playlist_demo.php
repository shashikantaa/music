...
<html lang="en">
  ...
  <div class="sidebar">
    ...
    <div class="main-container">
      ...
      <h3 style="text-align:left;color:white">ADD TO PLAYLIST</h3>
      <!--SONGS DISPLAY-->
      <?php	
	session_start();
...
<div >
  <table align="center" width="100%" style="background-color:black; border-color:white; border-top:none; border-left:none; border-right:none; border-top-color:black; border-right-color:black; border-left-color:black;">
        <tr class="song_disp">
            <td>
                <a class="song_link" href="#"><?php echo $value['song_name'];?></a>
   </td>
   <td>
   <a class="play_1" href="play_demo2.php?a=<?php echo $value['artist_id'];?>&l=<?php echo $value['loc'];?>&s=<?php echo $value['song_name'];?>">Add To Playlist</a></td>
   </td>
        </tr>
    </table>
