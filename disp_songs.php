        ...
        <ul>
          ...
          <?php 
        	if(!empty($_SESSION['id']))
		      {
?>
          <a href="playlist_demo.php" style="color:white;font-size:12px;text-decoration:none;font-weight:bold;color:lightgrey;">
...
<div >
  <table align="center" width="100%"  style="background-color:black; border-color:white; border-top:none; border-left:none; border-right:none; border-top-color:black; border-right-color:black; border-left-color:black;">
        <tr class="song_disp">
            <td>
                <a class="song_link"><?php echo $value['song_name'];?></a>
            </td>
            <td>
              <a href="demo.php?a=<?php echo $value['artist_id'];?>&l=<?php echo $value['loc'];?>&s=<?php echo $value['song_name'];?>" class="song_link play_1">Play</a></td>
   </td>
        </tr>
    </table>
   </div>
